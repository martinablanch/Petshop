        ...
        <div className="container">
            ...
            <div className="row mb-6 me-5">
                <div className="col-md-12 text-center d-flex justify-content-center">
                    {sold ? <Link to={"/cart"} className="btn btn-outline-dark">Finalizar compra</Link> : <button type="button" className="btn btn-outline-dark" onClick={() => { addToCart(counter) }}> Agregar al carrito </button>}
